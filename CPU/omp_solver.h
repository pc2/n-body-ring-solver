...
int omp_accuracy(size_t start_N, size_t step_N, size_t num_steps, double T, double ratio, std::string output_file, Vectorization_type vect_type, Data_type data_type, bool verbose);
