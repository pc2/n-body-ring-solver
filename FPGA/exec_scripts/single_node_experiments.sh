...
srun -l --cpu-bind=cores --ntasks-per-node=1 ./main.out -t lrbd -suffix _no_sync_local     -i lf -order 2 -start 128 -step 128   -n 32 -f_max 262.5  -LPE 4 -RPE 4 -nd -topology ringN -warm-up 2 -o single_node.csv -T 10.0
srun -l --cpu-bind=cores --ntasks-per-node=1 ./main.out -t lrbd -suffix _L16_sp_s42        -i lf -order 2 -start 128 -step 128   -n 32 -f_max 280    -LPE 8 -RPE 8 -nd -topology ringN -warm-up 2 -o single_node.csv -T 10.0
...
srun -l --cpu-bind=cores --ntasks-per-node=1 ./main.out -t lrbd -suffix _no_sync_local     -i lf -order 2 -start 4096 -step 2048 -n 14 -f_max 262.5  -LPE 4 -RPE 4 -nd -topology ringN -warm-up 2 -o single_node.csv -T 10.0
srun -l --cpu-bind=cores --ntasks-per-node=1 ./main.out -t lrbd -suffix _L16_sp_s42        -i lf -order 2 -start 4096 -step 2048 -n 14 -f_max 280    -LPE 8 -RPE 8 -nd -topology ringN -warm-up 2 -o single_node.csv -T 10.0
