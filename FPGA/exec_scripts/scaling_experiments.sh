...
do
    ...
    do
        ...
        ./main.out -t lrbd -suffix _no_sync_local -i lf -order 2 -N $strong_N  -T 30.0 -f_max 262.5 -LPE 4 -RPE 4 -nd -topology ringN -warm-up 2 -o strong_scaling.csv
...
do
    ...
    do
        ...
        srun -p fpga -A hpc-lco-kenter --constraint=19.4.0_max -N $nodes --fpgalink=ringN -t 10:00 -l --cpu-bind=cores --ntasks-per-node=1 \
        ./main.out -t lrbd -suffix _no_sync_local -i lf -order 2 -N $curr_N  -T 30.0 -f_max 262.5 -LPE 4 -RPE 4 -nd -topology ringN -warm-up 2 -o weak_scaling.csv
        #Let the previous job finish
        sleep 120
    done
done 
