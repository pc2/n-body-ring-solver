...
aoc -v -board=p520_max_sg280l device/ring_lrbd_lf_sp.cl -global-ring -duplicate-ring -seed=42 -o bin/ring_lrbd_8x8PE_L16_sp_s42.aocx -DPE_LOCAL_CNT=8 -DPE_LOCAL_CNT_ALLOC=8 -DPE_REMOTE_CNT=8 -DPE_REMOTE_CNT_ALLOC=8 -DLATENCY_FACTOR=16
